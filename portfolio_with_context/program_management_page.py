...
def show_program_tracker(data_layer):
    ...
    # =========================================================================
    with tab1:
        show_portfolio_summary(sites, data_layer)
    ...
    # =========================================================================
    with tab3:
        show_tracker_editor(sites, data_layer)
    
    # =========================================================================
    # TAB 4: Fee Calculation Settings
    # =========================================================================
    with tab4:
        show_fee_settings(sites, data_layer)


def show_portfolio_summary(sites: Dict, data_layer):
...
def show_tracker_editor(sites: Dict, data_layer):
    ...
    with st.form("tracker_edit_form"):
        ...
        if submitted:
            ...
            if data_layer.save_site(site_id, updated_site):
...
def show_fee_settings(sites: Dict, data_layer):
